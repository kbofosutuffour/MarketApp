      ...
      <ScrollView>
        <View style={styles.privacyPolicy}>
          <Text style={styles.title}>
            Privacy Policy of William and Mary market app
          </Text>
          <Text>
          ...
          <View style={styles.section}>
            ...
            <Text>
              ...
              Policy, if available. Users are responsible for any third-party
              Personal Data obtained, published or shared through this
              Application and confirm that they have the third party's consent
          ...
          <View style={styles.section}>
            ...
            <Text>
              ...
              an agreement with the User and/or for any pre-contractual
              obligations thereof;
            </Text>
            <Text>
            ...
            <Text>
              processing are located. Depending on the User's location, data
              transfers may involve transferring the User's Data to a country
              other than their own. To find out more about the place of
              processing of such transferred Data, Users can check the section
              containing details about the processing of Personal Data. Users
              are also entitled to learn about the legal basis of Data transfers
              ...
              taken by the Owner to safeguard their Data. If any such transfer
              takes place, Users can find out more by checking the relevant
              sections of this document or inquire with the Owner using the
            ...
            <Text>
              ...
              a contract between the Owner and
            </Text>
            <Text>
            ...
            <Text>
              ...
              upon order of an authority. Once the retention period expires,
              Personal Data shall be deleted. Therefore, the right of access,
              the right to erasure, the right to rectification and the right to
              data portability cannot be enforced after expiration of the
              retention period.
            </Text>
          </View>
          <View style={styles.section}>
            ...
            <Text>
              ...
              the Owner is processing Personal Data for direct marketing
